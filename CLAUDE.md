...
**Current version:** 1.1 (2026-03-26)

## Files

| File | Purpose |
|------|---------|
| `carlquist_publications.csv` | Main dataset (343 records, 19 fields) |
...
|------|-------|--------|---------|
| `CITATION.cff` | `version:` | `1.1` | `version: 1.2` |
| `CITATION.cff` | `date-released:` | `YYYY-MM-DD` | `date-released: 2026-04-01` |
| `README.md` | `**Current Version:**` | `1.1` | `**Current Version:** 1.2` |
| `README.md` | `**Released:**` | `Month DD, YYYY` | `**Released:** April 1, 2026` |
| `DATA_DICTIONARY.md` | `**Version:**` | `1.1` | `**Version:** 1.2` |
| `DATA_DICTIONARY.md` | `**Last Updated:**` | `Month DD, YYYY` | `**Last Updated:** April 1, 2026` |
| `dataset_metadata.json` | `"version":` | `"1.1"` | `"version": "1.2"` |
| `dataset_metadata.json` | `"date_published":` | `"YYYY-MM-DD"` | `"date_published": "2026-04-01"` |
| `.zenodo.json` | `"publication_date":` | `"YYYY-MM-DD"` | `"publication_date": "2026-04-01"` |
...
- **Records:** 343 (as of v1.1)
- **Fields:** 19 (as of v1.1)
- **Encoding:** UTF-8
...
- **Wikidata IDs:** ~31% coverage (107 of 343 records)
